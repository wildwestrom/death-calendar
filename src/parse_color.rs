...
/// [SVG specification](https://www.w3.org/Graphics/SVG/1.1/types.html#DataTypeColor) into a
/// hexadecimal color.
#[allow(clippy::too_many_lines)]
pub fn parse_svg_color(color: &str) -> Result<HexColor, ParseHexColorError> {
